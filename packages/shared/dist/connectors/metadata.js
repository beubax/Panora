...
exports.CONNECTORS_METADATA = void 0;
const types_1 = require("../types");
exports.CONNECTORS_METADATA = {
    'crm': {
        'hubspot': {
            ...
            authStrategy: {
                strategy: types_1.AuthStrategy.oauth2
            },
            options: {
        ...
        'zoho': {
            ...
            urls: {
                ...
                apiUrl: (zohoLocationBaseUrl) => `${zohoLocationBaseUrl}/crm`,
        ...
        'active_campaign': {
            ...
            active: false,
            authStrategy: {
                strategy: types_1.AuthStrategy.api_key,
                properties: ['api_key']
            }
        },
        'affinity': {
            ...
            primaryColor: '#244CED',
            authStrategy: {
                strategy: types_1.AuthStrategy.basic,
                properties: ['password']
            }
        },
        'capsule': {
    ...
    'ats': {
        ...
        'workday': {
            urls: {
                ...
                apiUrl: 'https://api.us.workdayspend.com/services'
            },
    ...
    'hris': {
        ...
        'namely': {
            urls: {
                ...
                apiUrl: 'https://stoplight.io/mocks/namely/namely-api/182542',
    ...
    'ecommerce': {
        ...
        'shopify': {
            urls: {
                ...
                apiUrl: (storeName) => `https://${storeName}.myshopify.com`,
            },
        ...
        'woocommerce': {
            urls: {
                ...
                apiUrl: (storeName) => `https://${storeName}/wp-json/wc`,
            },
